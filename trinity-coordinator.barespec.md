...
USE: Get all pending work orders that need execution
...
- Desktop: Orchestration, planning, user interaction, approval
- Code: Implementation, debugging, testing, file operations
- Perplexity: Research, fact-checking, external knowledge, web search
