...
NOTE: Build approval tools (get_pending_builds, get_build_plan, approve_build, reject_build) are documented above but integrated into core workflow - not separate MCP tools
